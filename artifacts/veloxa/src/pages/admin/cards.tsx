...
import { Search, Loader2, CreditCard, CheckCircle, AlertTriangle, XCircle, EyeOff } from "lucide-react";
...
export default function AdminCards() {
  ...
  const getStatusConfig = (status: string) => {
    switch (status) {
      case "active":   return { color: "#34d399", bg: "rgba(52,211,153,0.1)",  border: "rgba(52,211,153,0.3)",  glow: "rgba(52,211,153,0.15)",  label: "Active",    Icon: CheckCircle };
      case "inactive": return { color: "#6b7280", bg: "rgba(107,114,128,0.1)", border: "rgba(107,114,128,0.3)", glow: "rgba(107,114,128,0.1)",  label: "Inactive",  Icon: EyeOff };
      case "lost":     return { color: "#f97316", bg: "rgba(249,115,22,0.1)",  border: "rgba(249,115,22,0.3)",  glow: "rgba(249,115,22,0.15)",  label: "Lost",      Icon: AlertTriangle };
      case "suspended":return { color: "#ef4444", bg: "rgba(239,68,68,0.1)",   border: "rgba(239,68,68,0.3)",   glow: "rgba(239,68,68,0.15)",   label: "Suspended", Icon: XCircle };
      default:         return { color: "#6b7280", bg: "rgba(107,114,128,0.1)", border: "rgba(107,114,128,0.3)", glow: "rgba(107,114,128,0.1)",  label: status,      Icon: EyeOff };
    }
  };
                      ...
                      <td className="px-5 py-4 whitespace-nowrap">
                        ...
                        >
                          ...
                          <SelectContent style={{ background: "#0d0020", border: "1px solid rgba(255,255,255,0.1)" }}>
                            {(["active", "inactive", "lost", "suspended"] as const).map(s => {
